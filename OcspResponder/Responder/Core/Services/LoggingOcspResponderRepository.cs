...
internal sealed class LoggingOcspResponderRepository : IOcspResponderRepository
{
    ...
    {
        public static readonly EventId ValidatedCertificate = new(1, nameof(ValidatedCertificate));
        public static readonly EventId MissingCertificate = new(2, nameof(MissingCertificate));
        public static readonly EventId InvalidCertificate = new(3, nameof(InvalidCertificate));
    }
}
