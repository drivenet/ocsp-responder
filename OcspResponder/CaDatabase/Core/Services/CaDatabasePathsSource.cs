...
internal sealed class CaDatabasePathsSource
{
    ...
    {
        public static readonly EventId MissingCertificate = new(1, nameof(MissingCertificate));
        public static readonly EventId MissingDatabase = new(2, nameof(MissingDatabase));
    }
}
