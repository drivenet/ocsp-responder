...
dotnet publish OcspResponder --output packages\linux-x64\ocsp-responder -c Release -r linux-x64 --self-contained false
...
del packages\linux-x64\ocsp-responder\web.config packages\linux-x64\ocsp-responder\*.deps.json packages\linux-x64\ocsp-responder\*settings.json packages\linux-x64\ocsp-responder\Microsoft.*.dll
